...
double x1 = rand()/(double)RAND_MAX; // dvoils - get rid of warning
...
//double y1 = sqrt(-2.*log_e(x1)) * cos(2*3.1416*x2); dvoils - get rid of warning
